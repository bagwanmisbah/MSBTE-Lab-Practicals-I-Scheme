package com.example.mycoredatabase;
...
public class MainActivity extends AppCompatActivity
{
    ...
    {
        myCoreDatabase.insertData(Integer.parseInt(rollno.getText().toString()),stud_name.getText().toString().trim(), branch.getText().toString().trim(), Integer.parseInt(marks.getText().toString()), Integer.parseInt(percentage.getText().toString()));
